...
#	Section 3-1: Names
#	Store names of a few friends into a list, print each person's name by accessing each element in the list, one at a time. 
...
#	Reuse list from above but instead of printing each person's name, print a message to them. Text should be the same in each message but each message should be personalized. 
friends = ['Lisa', 'Kelen', 'Bob', 'Vinnie']
...
#	Make a list that stores several modes types of your favorite mode of transport. Use list to print a series of statements about these items. 
